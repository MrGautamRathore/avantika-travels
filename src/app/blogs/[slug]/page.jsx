...
import { FiUser, FiClock, FiCalendar, FiArrowLeft, FiShare2, FiFacebook, FiTwitter, FiLinkedin, FiPhone } from "react-icons/fi"
...
export default function BlogDetailsPage({ params }) {
  ...
  const authorDescriptions = {
    "Spiritual Travel": "Specializing in Mahakal Darshan and Omkareshwar Yatra. We ensure your spiritual journey is peaceful, comfortable, and handled with care.",
    
    "Food & Culture": "From Sarafa's night market to Ujjain's street food, we guide you to the authentic tastes and vibrant traditions of the Malwa region.",
    
    "City Exploration": "Discover the hidden gems of Ujjain and Indore. Our local experts help you navigate the cities like a pro, covering all must-visit spots.",
    
    "Travel Tips": "Planning a trip can be overwhelming. We provide practical tips, logistics support, and reliable taxi services to make your MP trip hassle-free.",
    
    "Historical": "Madhya Pradesh is a land of ancient history. Let us take you back in time to explore the heritage forts, temples, and architectural marvels.",
    
    "default": "Your trusted travel partner in Ujjain. We help devotees and travelers explore the spiritual and natural beauty of Madhya Pradesh with comfort."
  }
const currentAuthorDesc = authorDescriptions[blog?.category] || authorDescriptions["default"]
  if (!blog) {
    return (
  ...
  const shareText = encodeURIComponent(`Check out this amazing guide: ${blog.title}`)
  ...
  return (
    <>
      ...
      <Head>
        ...
        <meta name="keywords" content={`Ujjain tourism, ${blog.category}, ${blog.title}, Mahakal Darshan guide, MP travel tips`} />
        
        {/* Open Graph / Facebook */}
        <meta property="og:type" content="article" />
        <meta property="og:url" content={`https://avantikatravels.com/blogs/${blog.slug}`} />
        ...
        <meta property="twitter:image" content={blog.image?.url || "/logo.png"} />
            ...
            <article className="lg:col-span-8">
              ...
              >
                <h3 className="text-lg font-bold text-gray-900 mb-4 flex items-center gap-2">
                    <FiShare2 className="text-primary" /> Share this useful guide
                </h3>
                <div className="flex gap-3 bg-primary rounded">
                  <a
                  ...
                  <a
                    ...
                    target="_blank" rel="noopener noreferrer"
                    className="w-10 h-10 bg-[#0A66C2] text-white rounded-full flex items-center justify-center hover:scale-110 transition-transform"
...
<div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
  <div className="flex items-center gap-4 mb-4">
    <div className="w-16 h-16 bg-primary/10 rounded-full flex items-center justify-center text-primary text-2xl font-bold overflow-hidden relative">
      {/* Logo Image */}
      <Image 
        src={'/logo.png'} 
    ...
    <div>
      <p className="font-bold text-gray-900">Avantika Travels</p>
      {/* Subtitle bhi dynamic kar sakte hain agar chahein, abhi static rakha hai */}
      <p className="text-sm text-gray-500">Ujjain & MP Experts</p>
    </div>
  </div>
  ...
  <p className="text-gray-600 text-sm mb-4 leading-relaxed">
    {currentAuthorDesc}
                ...
                <div className="rounded-2xl p-8 text-white shadow-lg relative overflow-hidden mt-4">
                  ...
                  <h3 className="font-bold text-2xl mb-2 text-primary">Want to visit Ujjain?</h3>
                  <p className="text-gray-800 mb-6 text-sm">
                    Book your Mahakal Darshan taxi and hotel package with us today.
                  </p>
                ...
                <div className="bg-gray-50 rounded-2xl p-6">
                    <h4 className="font-bold text-gray-900 mb-4">Explore More Topics</h4>
                    <div className="flex flex-wrap gap-2">
                        {['Ujjain', 'Omkareshwar', 'Travel Tips', 'Food', 'Festivals'].map(tag => (
                            <Link key={tag} href={`/blogs`} className="text-xs font-medium bg-white border border-gray-200 px-3 py-1.5 rounded-md hover:border-primary hover:text-primary transition-colors">
                                #{tag}
                            </Link>
                        ))}
                    </div>
